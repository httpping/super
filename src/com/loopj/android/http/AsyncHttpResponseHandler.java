...
public abstract class AsyncHttpResponseHandler implements ResponseHandlerInterface {
    ...
    public VpHttpClient vpHttpClient;
    ...
    public void onStart() {
    	...
    	//对话框
    	if (vpHttpClient!=null) {
    		if (vpHttpClient.isShowProgressDialog()) {
    			vpHttpClient.isMode = true;
    			vpHttpClient.startProgressDialog();
    		}
		}
    ...
    public void onFinish() {
    	...
    	//关闭进度栏
    	if (vpHttpClient!=null) {
			vpHttpClient.stopProgressDialog();
		}
    }
            ...
            switch (message.what) {
                case SUCCESS_MESSAGE:
                    ...
                    if (response != null && response.length >= 3) {
                    	ResultParseUtil.parseHeader((Header[]) response[1]);//获取服务器时间
