...
public class AsyncHttpClient {
    ...
    public static final int DEFAULT_SOCKET_TIMEOUT = 60 * 30 * 1000;
    public static final int DEFAULT_MAX_RETRIES = 3;
    public static final int DEFAULT_RETRY_SLEEP_TIME_MILLIS =200;
     ...
     * @return RequestHandle of future request process
     */
    protected RequestHandle get(String url, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    protected RequestHandle get(String url, RequestParams params, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    protected RequestHandle get(Context context, String url, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    protected RequestHandle get(Context context, String url, RequestParams params, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    protected RequestHandle get(Context context, String url, Header[] headers, RequestParams params, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    protected RequestHandle get(Context context, String url, HttpEntity entity, String contentType, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    protected RequestHandle post(String url, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    protected RequestHandle post(String url, RequestParams params, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    protected RequestHandle post(Context context, String url, RequestParams params, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    protected RequestHandle post(Context context, String url, HttpEntity entity, String contentType, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    protected RequestHandle post(Context context, String url, Header[] headers, RequestParams params, String contentType,
     ...
     * @return RequestHandle of future request process
     */
    protected RequestHandle post(Context context, String url, Header[] headers, RequestParams params, String contentType, HttpEntity entity,
                              ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    protected RequestHandle post(Context context, String url, Header[] headers, HttpEntity entity, String contentType,
                              ResponseHandlerInterface responseHandler) {
        HttpEntityEnclosingRequestBase request = addEntityToRequestBase(new HttpPost(getURI(url)), entity);
        if (headers != null) request.setHeaders(headers);
     ...
     * @return RequestHandle of future request process
     */
    protected synchronized RequestHandle sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, ResponseHandlerInterface responseHandler, Context context) {
        if (uriRequest == null) {
        ...
        Log.d(LOG_TAG, "request :" + uriRequest.getURI().toString()) ;
