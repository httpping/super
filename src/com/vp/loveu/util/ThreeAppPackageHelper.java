...
public class ThreeAppPackageHelper {
	...
	public static boolean isQQInstalled(Context context) {
		return ThreeAppPackageHelper.isPackage(context, PACKAGE_APP.QQ);
	}

	public static boolean isSinaInstalled(Context context) {
		return ThreeAppPackageHelper.isPackage(context, PACKAGE_APP.SINA);
	}

	public static boolean isWeChatInstalled(Context context) {
		return ThreeAppPackageHelper.isPackage(context, PACKAGE_APP.WX);
	}

	public static boolean isBDInstalled(Context context) {
		return ThreeAppPackageHelper.isPackage(context, PACKAGE_APP.BDMAP);
	}

	public static boolean isGDChatInstalled(Context context) {
		return ThreeAppPackageHelper.isPackage(context, PACKAGE_APP.GDMAP);
	}
