...
public class ClipImageBorderView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		//
		// double vPadding =
		// mVerticalPadding = (getHeight() * 2 - getWidth() * 3 + 6 *
...
//		double pDoubleHeight = (double) ((getHeight() * 100 - getWidth() * 145 + mHorizontalPadding * 290) / 200);
		double pDoubleHeight = (double) ((getHeight() - getWidth() + mHorizontalPadding * 2) / 2);
		mVerticalPadding = (int) pDoubleHeight;
	}
