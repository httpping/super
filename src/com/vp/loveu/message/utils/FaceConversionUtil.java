...
import com.vp.loveu.util.LoveuFileUtils;
...
public class FaceConversionUtil {
	...
	public static void releaseFaceUtil() {
		if (mFaceConversionUtil != null) {
			mFaceConversionUtil.emojiLists.clear();
	...
	public void getFileText(Context context) {
		ParseData(LoveuFileUtils.getEmojiFile(context), context);
	}
